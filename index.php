...
$postNoteData ['order']['note_attributes']['Child 1 Hair Color'] = $rowData[6];
$postNoteData ['order']['note_attributes']['Child 1 Hair Style'] = $rowData[7];
$postNoteData ['order']['note_attributes']['Child 1 Skin Tone'] = $rowData[8];
$postNoteData ['order']['note_attributes']['Child 1 to 2'] = $rowData[9];
$postNoteData ['order']['note_attributes']['Child 1 Favorite color'] = $rowData[10];
$postNoteData ['order']['note_attributes']['Child 2 Name'] = $rowData[11];
$postNoteData ['order']['note_attributes']['Child 2 Gender'] = $rowData[12];
$postNoteData ['order']['note_attributes']['Child 2 Hair Color'] = $rowData[13];
$postNoteData ['order']['note_attributes']['Child 2 Hair Style'] = $rowData[14];
$postNoteData ['order']['note_attributes']['Child 2 Skin Tone'] = $rowData[15];
$postNoteData ['order']['note_attributes']['Child 2 Favorite color'] = $rowData[16];
$postNoteData ['order']['note_attributes']['Child 2 to 1'] = $rowData[17];
